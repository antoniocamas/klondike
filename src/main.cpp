...
/////////////////////////////////
	...
	Suit club("clubs", "black", 13, frechNicknames);
	Suit spade("spades", "black", nCards, frechNicknames);
	Suit heart("hearts", "red", nCards, frechNicknames);
	Suit diamon("diamons", "red", nCards, frechNicknames);
